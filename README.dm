Test Automation Framework for www.salesforce.com


#CHECKLIST
-Create  login ("LoginTest")
-Create new account ("AccountTest")
-Provide the cross browser testing (Chrome browser, Opera browser)
-NOTE: to check IP address in Network Access area, or/and add new IP address
